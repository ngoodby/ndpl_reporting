...
All acoustic results were uploaded to NABat project `r project_df$project_name[1]` and can be viewed `r proj_link`. *Note that you need to have a NABat account and be a member of the project to be able to view the results on NABat.*
