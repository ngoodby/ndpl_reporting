...
proj_link <- sprintf("https://sciencebase.usgs.gov/nabat/#/projects/%s", project_df$project_id[1])
```

Acoustic results were uploaded to NABat project `r project_df$project_name[1]` and can be viewed [here](proj_link)
