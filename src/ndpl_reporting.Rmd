...
![](../logos/BCI_logo.png){height=90}   ![](../logos/CMI_logo.jpg){height=90} 
...
```{r results = 'asis'}
if (report_type=="mobile"){
  cat("***In `r this_year`, we confirmed the presence of `r total_species_this_year` bat species (see Table \\@ref(tab:mobileresults)):***")
}
```
...
if (report_type=='mobile'){
  ...
  mobile_table_this_year <- filtered_mobile_all_dat %>% 
    ...
    rename("Transect Name"=site_name, "Monitoring Night"=start_night)
