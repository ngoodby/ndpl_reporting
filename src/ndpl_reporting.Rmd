...
data <- load_nabat_data(username, password, project_id)
all_dat <- data[[1]]
dat_count <- data[[2]]
```
...
sf::st_write(map[[2]], dsn = here::here("geojson_files", "grts_boundaries.geojson"), layer = "grts_boundaries.geojson", delete_dsn = T, quiet=T)
sf::st_write(map[[3]], dsn = here::here("geojson_files", "site_locs.geojson"), layer = "site_locs.geojson", delete_dsn = T, quiet=T)
map[[1]]
```
