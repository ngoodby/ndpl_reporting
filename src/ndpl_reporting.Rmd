...
![](../logos/BCI_logo.png){height=80} ![](../logos/CMI_logo.jpg){height=70} 
...
if (report_type=="mobile"){
  cat(sprintf('Mobile acoustic surveys were conducted on %s nights in %s. Figure shows all mobile transect routes conducted. Full spectrum echolocation files were recorded using the detectors in Table', n_distinct(mobile_all_dat$recording_night), this_year))
}
```
...
4. Assigning the file as noise, i.e., not a recording of bat echolocation calls. 
