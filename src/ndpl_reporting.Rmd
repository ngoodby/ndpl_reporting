...
metadata <- all_dat %>% 
  dplyr::filter(year == this_year) %>% 
  dplyr::group_by(grts_cell_id, location_name, detector_type_id, detector_serial_number, microphone_type_id) %>% 
...
metadata %>% flextable() %>% 
  ...
  set_header_labels(.,
                    ...
                    detector_type_id = "Detector Type",
                    detector_serial_number = "Detector Serial #",
                    microphone_type_id = "Microphone Type") %>% 
