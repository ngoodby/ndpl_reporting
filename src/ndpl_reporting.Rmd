...
For stationary data, we attempted to confirm the identification of at least one acoustic file per species, per night, per site by visually inspecting the species ID proposed by the programs. Up to ten files per species-site-night were reviewed in an attempt to confirm the species ID.
...
1. Confirming species ID as assigned by the programs; 
