...
<img src="../logos/BCI_logo.png" width="auto" height="120" style="padding:15px;"/>
<img src="../logos/CMI_logo.jpg" width="auto" height="120" style="padding:15px;"/>
```{r results='asis'}
...
if (paste0(partner, ".png") %in% logos){
  cat(sprintf('<img src="../logos/%s.png" width="auto" height="120" style="padding:15px;"/>', 
              partner))
