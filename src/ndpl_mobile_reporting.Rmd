...
mobile_exclude <- c("Noise", "NOISE", NA)
```
...
#mobile
source(here::here('src', 'get_mobile_acoustic_data_function.R'))
mobile_data <- load_mobile_data(username, password, project_id, report_grts)
