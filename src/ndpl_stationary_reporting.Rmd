...
setdiff <- setdiff(total_species_this_year, total_species_prev_year)
setdiff

#spp only confirmed in previous years
setdiff2 <- setdiff(total_species_prev_year, total_species_this_year)
setdiff2

# test <- c("Eptesicus fuscus")


if(setdiff == c("Lasiurus cinereus","Corynorhinus townsendii")){
  print('Lasiurus cinereus and Corynorhinus townsendii were recorded the first time this year.')
} else {
